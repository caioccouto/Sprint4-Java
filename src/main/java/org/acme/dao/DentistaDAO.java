...
public class DentistaDAO {
    ...
    public void deletarDent(Long id) throws SQLException{
    ...
    public void atualizarDent(Dentista d) throws SQLException{
    ...
    public Dentista buscarDentPorId(Long id) throws SQLException {
